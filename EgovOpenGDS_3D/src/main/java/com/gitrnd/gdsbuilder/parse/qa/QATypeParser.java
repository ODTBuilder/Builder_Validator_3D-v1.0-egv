 ...
 */
package com.gitrnd.gdsbuilder.parse.qa;
...
import com.gitrnd.gdsbuilder.type.validate.option.specific.AttributeFigure;
import com.gitrnd.gdsbuilder.type.validate.option.specific.AttributeFilter;
 ...
 * {@link com.gitrnd.gdsbuilder.parser.file.writer.SHPFileWriter} 형태로 변환하는 클래스
 * 
 * @author DY.Oh
 */
public class QATypeParser {
	...
	/**
	 * {@link com.gitrnd.gdsbuilder.parser.file.writer.SHPFileWriter}형태의 검수 옵션 정보
	 */
	...
	/**
	 * JSONArray 형태의 검수 옵션(검수 항목 및 검수 항목별 세부 설정)정보를
	 * {@link com.gitrnd.gdsbuilder.parser.file.writer.SHPFileWriter} 형태로 변환을 위한
	 * 생성자
	 * 
	...
	/**
	 * JSONArray 형태의 검수 옵션(검수 항목 및 검수 항목별 세부 설정)정보를
	 * {@link com.gitrnd.gdsbuilder.parser.file.writer.SHPFileWriter} 형태로 변환
	 * 
	 * @author DY.Oh
	 */
