 ...
 */
package com.gitrnd.gdsbuilder.type.dt.collection;

import com.gitrnd.gdsbuilder.type.dt.layer.DTLayer;
import com.gitrnd.gdsbuilder.type.dt.layer.DTLayerList;

/**
 * {@link com.gitrnd.gdsbuilder.type.dt.collection.DTLayerCollection}정보를 저장하는 클래스.
 * <p>
 * 다수의 레이어를 동시에 검수 할 때 검수 레이어 {@link com.gitrnd.gdsbuilder.type.dt.layer.DTLayer}
 * 또는 {@link com.gitrnd.gdsbuilder.quadtree.Quadtree.DTQuadLayer}를 List 형태로 저장 가능
 * <p>
 * {@link com.gitrnd.gdsbuilder.type.dt.collection.DTLayerCollection}의
...
public class DTLayerCollection {
	 ...
	 * {@link com.gitrnd.gdsbuilder.type.dt.layer.DTLayerList} 중 layerName에 해당하는
	 * {@link com.gitrnd.gdsbuilder.type.dt.layer.DTLayer}를 반환
	 * 
	 * @param layerName
	 *            반환하고자 하는 {@link com.gitrnd.gdsbuilder.type.dt.layer.DTLayer} 이름
