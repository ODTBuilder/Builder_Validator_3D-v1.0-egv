 ...
 * <p>
 * 다수의{@link com.gitrnd.gdsbuilder.type.dt.collection.DTLayerCollection}을 List 형태로
 * 저장
 * 
 * @author DY.Oh
 */
public class DTLayerCollectionList extends ArrayList<DTLayerCollection> {
	 ...
	 * {@link com.gitrnd.gdsbuilder.type.dt.collection.DTLayerCollectionList} 중
	 * collectionName에 해당하는
	 * {@link com.gitrnd.gdsbuilder.type.dt.collection.DTLayerCollection}를 반환
	 * 
	...
	/**
	 * DTLayerCollectionList에 저장된
	 * {@link com.gitrnd.gdsbuilder.type.dt.collection.DTLayerCollectionList} 중 인접 도엽
	 * 정보인 {@link com.gitrnd.gdsbuilder.type.dt.collection.MapSystemRule}에 해당하는 상, 하,
	 * 좌, 우 각각의 {@link com.gitrnd.gdsbuilder.type.dt.collection.DTLayerCollection}를
	 * {@link com.gitrnd.gdsbuilder.type.dt.collection.DTLayerCollectionList}에 담아 반환
	 * 
	 * @param mapSystemRule
