...
public class GraphicMiss {
	...
	/**
	 * {@link com.gitrnd.gdsbuilder.type.validate.option.specific.OptionFigure}에
	 * 저장된 레이어의 속성 key, value 정보에 따라 검수 대상 레이어의 검수 수행
	 */
	List<OptionFigure> figure;
	/**
	 * 검수 대상 레이어와
	 * {@link com.gitrnd.gdsbuilder.type.validate.option.specific.OptionRelation}에
	 * 저장된 타 레이어와의 위상관계 검수 대상 레이어의 검수 수행
	 */
	List<OptionRelation> retaion;
	/**
	 * {@link com.gitrnd.gdsbuilder.type.validate.option.specific.OptionTolerance}에
	...
	/**
	 * layerID에 해당하는
	 * {@link com.gitrnd.gdsbuilder.type.validate.option.specific.OptionFilter} 반환
	 * 
	 * @param layerID
	 *            layerID
	 * @return OptionFilter layerID에 해당하는
	 *         {@link com.gitrnd.gdsbuilder.type.validate.option.specific.OptionFilter}
	 * 
	 * @author DY.Oh
	 */
	...
	/**
	 * layerID에 해당하는
	 * {@link com.gitrnd.gdsbuilder.type.validate.option.specific.OptionFigure} 반환
	 * 
	 * @param layerID
	 *            layerID
	 * @return OptionFigure layerID에 해당하는
	 *         {@link com.gitrnd.gdsbuilder.type.validate.option.specific.OptionFigure}
	 * 
	 * @author DY.Oh
	 */
	...
	/**
	 * layerID에 해당하는
	 * {@link com.gitrnd.gdsbuilder.type.validate.option.specific.OptionTolerance}
	 * 반환
	 * 
	 * @param layerID
	 *            layerID
