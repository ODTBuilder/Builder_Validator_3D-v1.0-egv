...
/**
 * 검수 대상 {@link com.gitrnd.gdsbuilder.type.dt.collection.DTLayerCollection}의
 * 인접도엽(상, 하, 좌, 우)
 * {@link com.gitrnd.gdsbuilder.type.dt.collection.DTLayerCollectionList}의 ID를 담고
 * 있는 클래스
 * <p>
 * 인접도엽 ID는 검수 대상
 * {@link com.gitrnd.gdsbuilder.type.dt.collection.DTLayerCollection}의 ID가 숫자인 경우
 * 해당 {@link com.gitrnd.gdsbuilder.type.dt.collection.DTLayerCollection}의 ID를 기준으로
...
public class MapSystemRule {
	...
	/**
	 * 검수 대상 {@link com.gitrnd.gdsbuilder.type.dt.collection.DTLayerCollection}
