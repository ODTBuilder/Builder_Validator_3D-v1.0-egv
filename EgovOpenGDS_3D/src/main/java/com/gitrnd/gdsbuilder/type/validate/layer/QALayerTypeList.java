 ...
 * <p>
 * 다수의{@link com.gitrnd.gdsbuilder.type.validate.layer.QALayerType}을
...
public class QALayerTypeList extends ArrayList<QALayerType> {
	...
	/**
	 * 특정 Name에 해당하는 {@link com.gitrnd.gdsbuilder.type.validate.layer.QALayerType}의
	 * LayerID List와 동일한 ID를 가진
	 * {@link com.gitrnd.gdsbuilder.type.dt.layer.DTLayer}를
	 * {@link com.gitrnd.gdsbuilder.type.dt.collection.DTLayerCollection}에서 모두 검색하여
	 * {@link com.gitrnd.gdsbuilder.type.dt.layer.DTLayerList} 형태로 반환
	 * 
	 * @param typeName
	 *            {@link com.gitrnd.gdsbuilder.type.validate.layer.QALayerType}
	 *            Name
	 * @param layerCollection
	 *            LayerID를 검색할
	 *            {@link com.gitrnd.gdsbuilder.type.dt.collection.DTLayerCollection}
	 * @return DTLayerList
	 *         {@link com.gitrnd.gdsbuilder.type.validate.layer.QALayerType}의
	 *         LayerID List와 동일한 ID를 가진
	 *         {@link com.gitrnd.gdsbuilder.type.dt.layer.DTLayerList}
	 * 
	 * @author DY.Oh
	 */
	...
	/**
	 * 특정 Name에 해당하는 {@link com.gitrnd.gdsbuilder.type.validate.layer.QALayerType}의
	 * LayerID와 동일한 ID를 가진 {@link com.gitrnd.gdsbuilder.type.dt.layer.DTLayer}를
	 * {@link com.gitrnd.gdsbuilder.type.dt.collection.DTLayerCollection}에서 검색하여 반환
	 * 
	 * @param typeName
	 *            {@link com.gitrnd.gdsbuilder.type.validate.layer.QALayerType}
	 *            Name
	 * @param layerID
	 *            {@link com.gitrnd.gdsbuilder.type.dt.layer.DTLayer} ID
	 * @param layerCollection
	 *            LayerID를 검색할
	 *            {@link com.gitrnd.gdsbuilder.type.dt.collection.DTLayerCollection}
	 * @return DTLayer
